# Deebus
    This is the backend repository for deebus application for the global Developer students club Solution
    challenge.
...
```bash
git clone https://github.com/dscfuto-org/deebus-BE.git ./myproject
```
